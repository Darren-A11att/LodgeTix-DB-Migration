...
import UnifiedPaymentSyncService from '../src/services/sync/unified-payment-sync';
...
async function main() {
  console.log('=== UNIFIED PAYMENT SYNC ===');
  ...
  const syncService = new UnifiedPaymentSyncService();
