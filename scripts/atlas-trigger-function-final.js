exports = async function(changeEvent) {
  // IMPORTANT: Replace 'Cluster0' with your actual cluster name from Atlas
  // You can find this in your Atlas dashboard or in the "Linked Data Source" section
  const mongodb = context.services.get("Cluster0"); // <-- CHANGE THIS TO YOUR CLUSTER NAME
