exports = async function(changeEvent) {
  // IMPORTANT: The service name must match your linked data source name EXACTLY
  // Common names are: "mongodb-atlas", "Cluster0", or your cluster name
  // Check in Atlas: App Services → Linked Data Sources → See the exact name
  
  // Try these common service names (uncomment the one that works):
  
  // Option 1: Default service name
  // const mongodb = context.services.get("mongodb-atlas");
  
  // Option 2: Your cluster name (most likely based on your connection string)
  const mongodb = context.services.get("LodgeTix");
  
  // Option 3: Alternative cluster names
  // const mongodb = context.services.get("lodgetix-migration-test");
  // const mongodb = context.services.get("Cluster0");
  
  // If none work, you can debug by logging available services:
