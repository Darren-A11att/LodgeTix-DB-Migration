        ...
        if (!registration) {
          ...
          falseMatches.push({
            ...
            paymentDetails: {
              ...
              customerName: payment.customerName || payment.originalData?.['Customer Name'],
        ...
        if (!paymentIdFound) {
          ...
          falseMatches.push({
            ...
            registrationDetails: {
              ...
              totalAmount: registration.totalAmountPaid?.$numberDecimal ? 
...
function searchForPaymentId(obj: any, paymentId: string, visited = new Set()): boolean {
