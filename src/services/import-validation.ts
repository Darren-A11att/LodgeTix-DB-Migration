import { ImportQueueItem, ValidationError } from '../types/payment-import';
...
export class ImportValidationService {
   ...
   */
  static validateQueueItem(item: ImportQueueItem): ValidationError[] {
   ...
   */
  private static validatePaymentData(item: ImportQueueItem): ValidationError[] {
    const errors: ValidationError[] = [];
   ...
   */
  private static validateRegistrationData(item: ImportQueueItem): ValidationError[] {
    const errors: ValidationError[] = [];
   ...
   */
  private static validateAmountMatch(item: ImportQueueItem): ValidationError[] {
    const errors: ValidationError[] = [];
   ...
   */
  private static validateCustomerMatch(item: ImportQueueItem): ValidationError[] {
    const errors: ValidationError[] = [];
   ...
   */
  private static validateDateConsistency(item: ImportQueueItem): ValidationError[] {
    const errors: ValidationError[] = [];
   ...
   */
  private static validateDuplicates(item: ImportQueueItem): ValidationError[] {
    const errors: ValidationError[] = [];
   ...
   */
  private static validateBusinessRules(item: ImportQueueItem): ValidationError[] {
    const errors: ValidationError[] = [];
